...
public class Chat_activity extends AppCompatActivity {
    ...
    private EditText messageinuttext;
    ...
    private void Intializecontrollers() {
        ...
        sendmessagebutton = findViewById(R.id.send_chat_msg_btn);
        messageinuttext = findViewById(R.id.input_message);
    ...
    {
        final String messagetext = messageinuttext.getText().toString();
        ...
        else
        {
            ...
            Rootref.updateChildren(messagebodydetail).addOnCompleteListener(new OnCompleteListener() {
                ...
                public void onComplete(@NonNull Task task) {
                    ...
                    {
                        Toast.makeText(Chat_activity.this, "Message sended..!", Toast.LENGTH_SHORT).show();
